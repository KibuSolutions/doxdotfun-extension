...
![GitHub action badge](http://kibu.solutions/doxdotfun/actions/workflows/build-zip.yml/badge.svg)
![GitHub action badge](http://kibu.solutions/doxdotfun/actions/workflows/lint.yml/badge.svg)

<img src="https://hits.seeyoufarm.com/api/count/incr/badge.svg?url=http://kibu.solutions/doxdotfunFactions&count_bg=%23#222222&title_bg=%23#454545&title=😀&edge_flat=true" alt="hits"/>
<a href="https://discord.gg/4ERQ6jgV9a" target="_blank"><img src="https://discord.com/api/guilds/1263404974830915637/widget.png"/></a>

> This boilerplate
> has [Legacy version](http://kibu.solutions/doxdotfun/tree/legacy)
...
2. Clone this repository.( ```git clone http://kibu.solutions/doxdotfun``` )
...
1. Run:
    - Dev: `pnpm dev` (on Windows, you should run as administrator;
      see [issue#456](http://kibu.solutions/doxdotfun/issues/456))
    - Prod: `pnpm build`
...
2. If you get a [`grpc` error](http://kibu.solutions/doxdotfun/issues/612),
   [kill the
   `turbo` process](http://kibu.solutions/doxdotfun/issues/612#issuecomment-2518982339)
...
<a href="http://kibu.solutions/doxdotfun/graphs/contributors">
